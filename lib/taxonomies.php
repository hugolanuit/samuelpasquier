...
class Theme_CustomTaxonomies
{
    ...
    /**
     * Register 'project_category' taxonomy
     *
     * @method project_category
     */
    public function project_category()
    {
        $taxonomy_name = "project_category";
        $name = __('Categories', 'mill3wp');
        $singular_name = __('Category', 'mill3wp');
        $slug = __("project-categories", 'mill3wp');
        $labels = $this->labels($name, $singular_name);
    ...
    /**
     * Register 'commission_category' taxonomy
     *
     * @method commission_category
     */
    public function commission_category()
    {
        $taxonomy_name = "commission_category";
        $name = __('Categories', 'mill3wp');
        $singular_name = __('Category', 'mill3wp');
        $slug = __("commission-categories", 'mill3wp');
        $labels = $this->labels($name, $singular_name);
